...
| **Avg. Revenue per Customer** | $\mathbf{\$48,882.40}$ | The average sales value generated by a single customer. |
| **Total Products** | $\mathbf{50}$ | The unique count of products in the inventory. |
| **Avg. Revenue per Product** | $\mathbf{\$104,608.34}$ | The average revenue generated by each product line. |
